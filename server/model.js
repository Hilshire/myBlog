...
exports.blog = {
    ...
    queryList: createGetFn('SELECT id, title, summary, time From blog ORDER BY TIME DESC LIMIT ?, ?', 'all'),
    queryListCount: createGetFn('SELECT COUNT(*) AS val FROM blog'),
...
exports.article = {
    ...
    queryList: createGetFn('SELECT id, title, content, time FROM article ORDER BY TIME DESC LIMIT ?, ?', 'all'),
    queryListCount: createGetFn('SELECT COUNT(*) AS val FROM article'),
...
exports.tips = {
    ...
    queryList: createGetFn('SELECT id, title, content, time FROM tips ORDER BY time DESC LIMIT ?, ?', 'all'),
    queryListCount: createGetFn('SELECT COUNT(*) AS val FROM tips'),
