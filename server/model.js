...
exports.blog = {
    ...
    queryList: createGetFn('SELECT id, title, summary, time From blog ORDER BY TIME DESC', 'all'),
...
exports.article = {
    ...
    queryList: createGetFn('SELECT id, title, content, time FROM article ORDER BY TIME DESC', 'all'),
...
exports.tips = {
    ...
    queryList: createGetFn('SELECT id, title, content, time FROM tips ORDER BY time DESC', 'all'),
